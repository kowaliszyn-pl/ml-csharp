...
{
    public Trainer4D(NeuralNetwork<float[,,,], float[,]> neuralNetwork, Optimizer optimizer, SeededRandom random, ILogger<Trainer4D> logger) : base(neuralNetwork, optimizer, random: random, logger: logger)
    {
    }
