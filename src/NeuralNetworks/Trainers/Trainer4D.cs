...
{
    public Trainer4D(GenericModel<float[,,,], float[,]> model, Optimizer optimizer, SeededRandom random, ILogger<Trainer4D> logger) : base(model, optimizer, random: random, logger: logger)
    {
    }
