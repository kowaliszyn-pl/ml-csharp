...
{
    public Trainer2D(BaseModel<float[,], float[,]> model, Optimizer optimizer, SeededRandom? random, ILogger<Trainer2D>? logger = null) : base(model, optimizer, random: random, logger: logger)
    {
    }
