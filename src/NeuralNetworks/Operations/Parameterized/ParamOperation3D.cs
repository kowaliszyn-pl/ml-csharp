...
public abstract class ParamOperation3D : Operation3D, IParamOperation
{
...
public abstract class ParamOperation3D<TParam>(TParam param) : ParamOperation3D
    where TParam : class
{
    ...
    {
        ParamOperation3D<TParam> clone = (ParamOperation3D<TParam>)base.CloneBase();
