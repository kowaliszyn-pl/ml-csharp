...
public class SimpleDataSource<TInputData, TPrediction>(TInputData xTrain, TPrediction yTrain, TInputData? xTest = default, TPrediction? yTest = default) : DataSource<TInputData, TPrediction>
